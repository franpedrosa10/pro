      ...
      <main className="page-shell">
        <div className="app-container fade-in">
          <section className="panel p-5">
            <h1 className="text-5xl leading-none sm:text-6xl">Invitacion invalida</h1>
            <p className="section-subtitle mt-2 text-sm">El codigo de liga no cumple formato valido.</p>
      ...
      <main className="page-shell">
        <div className="app-container fade-in">
          <section className="panel p-5">
            ...
            <p className="section-subtitle mt-2 text-sm">No pudimos resolver esa invitacion.</p>
            <Link href="/dashboard/leagues" className="btn-primary mt-4 inline-flex px-4 py-2 text-sm">
              Ir a Ligas
            </Link>
          </section>
    ...
    <main className="page-shell">
      <div className="app-container fade-in">
        <section className="panel-strong p-5 sm:p-7">
          <p className="chip w-fit">Invitacion</p>
          <h1 className="mt-2 text-5xl leading-none sm:text-7xl">{row.league_name}</h1>
          <p className="mt-2 text-sm text-[#4c5564]">
            Codigo: <span className="rounded bg-[#1d2430] px-2 py-1 font-mono text-xs text-[#ffe289]">{row.join_code}</span>
          </p>
