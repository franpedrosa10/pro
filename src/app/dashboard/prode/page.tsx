...
> = {
  es: {
    ...
    predictions: {
      ...
      editable: "Editable",
      finalPrefix: "Final",
      noFixtures: "No hay partidos cargados. Ejecuta supabase/seed.sql o importa fixtures reales.",
  ...
  en: {
    ...
    predictions: {
      ...
      editable: "Editable",
      finalPrefix: "Final",
      noFixtures: "No matches loaded. Run supabase/seed.sql or import real fixtures.",
  ...
  pt: {
    ...
    predictions: {
      ...
      editable: "Editavel",
      finalPrefix: "Final",
      noFixtures: "Nao ha partidas carregadas. Execute supabase/seed.sql ou importe fixtures reais.",
