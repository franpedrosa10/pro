...
> = {
  es: {
    ...
    subtitle: "Crea una liga, unite por codigo y comparti invitacion directa por link.",
    createLeague: "Crear liga",
    joinByCode: "Unirme por codigo",
    ...
    createdPrefix: "Liga creada. Codigo",
    ...
    sharedOk: "Invitacion compartida.",
